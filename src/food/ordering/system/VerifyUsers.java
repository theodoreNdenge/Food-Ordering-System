...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email) {
        ...
        while(itr.hasNext()) {
            ...
            if(!userObj.getEmail().equals("admin@gmail.com")) {
                dtm.addRow(new Object[] {userObj.getId(), userObj.getFullName(), userObj.getMobileNumber(), userObj.getEmail(), userObj.getSecurityQuestion(), userObj.getStatus()});                
            }                
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(658, 83, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(546, 109, 300, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Mobile Number", "Email", "Security Question", "Status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 149, 1300, 547));

        jLabel3.setFont(new java.awt.Font("Algerian", 1, 36)); // NOI18N
        jLabel3.setText("*Click on row to Change Status");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(387, 714, -1, -1));
